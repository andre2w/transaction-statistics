...
public class AT_TransactionStatistics {
    ...
    @Autowired
    private TransactionStatisticsStore transactionStatisticsStore= new TransactionStatisticsStore();
    ...
    public void return_statistics_for_transactions() throws Exception {
        transactionStatisticsStore.add(new Transaction(new BigDecimal("100.0000"), ZONED_DATE_TIME_NOW));
        transactionStatisticsStore.add(new Transaction(new BigDecimal("50.0000"), ZONED_DATE_TIME_NOW));
